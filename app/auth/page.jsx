                ...
                <div className="hidden md:block md:w-1/2 bg-indigo-600">
                    <div className="h-full flex items-center justify-center p-12">
                        <div className="max-w-md text-white">
                            <h2 className="text-3xl font-bold mb-6">Transform Your Learning Experience with AI</h2>
                            <p className="text-indigo-100 text-lg mb-8">
                                StudyBuddy AI turns your course materials into personalized learning experiences,
                                interactive exercises, and exam prep tools.
                            </p>
                            <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
                                <div className="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-indigo-200 text-sm">Computer Science Student</p>
                                    </div>
                                </div>
                                <p className="italic text-indigo-100">
                                    "StudyBuddy AI helped me prepare for my exams in half the time. The personalized
                                    practice questions and AI explanations made complex topics much easier to understand."
                                </p>
                            </div>
                        </div>
                    </div>
